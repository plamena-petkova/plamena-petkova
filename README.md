# 👋 Hi there, I'm Plamena Petkova

🎯 **Frontend Developer** | 🌐 **React & Next.js Enthusiast** | 🇧🇬 Based in Varna, Bulgaria  
...
[![Portfolio](https://img.shields.io/badge/plamena-petkova-blue?style=flat-square)](https://plamena-petkova.vercel.app)
...
![SASS](https://img.shields.io/badge/-SASS-CC6699?logo=sass&style=flat-square)
![TailwindCSS](https://img.shields.io/badge/-Tailwind-06B6D4?logo=tailwindcss&style=flat-square)
![Material UI](https://img.shields.io/badge/-MUI-007FFF?logo=mui&style=flat-square)
![DaisyUI](https://img.shields.io/badge/-DaisyUI-FF69B4?style=flat-square)

**Tools & Platforms:**  
![Git](https://img.shields.io/badge/-Git-F05032?logo=git&style=flat-square)
![GitHub Actions](https://img.shields.io/badge/-GitHub%20Actions-2088FF?logo=githubactions&style=flat-square)
...
### 💬 [ChatZak](https://chatzak.netlify.app)  
...
- **Frontend Web Developer**, SoftUni – React, Angular, Node.js, MongoDB  
- **Economics**, University of National and World Economy  
...
Empathy • Teamwork • Adaptability • Attention to Detail • Critical Thinking • Positive Attitude
